...
public class ContentextMenuCatalog extends AbstractPage
{
	...
	public ContentextMenuCatalog()
	{
		...
		// Menu //
		this.add(new Menu("menu", ContentextMenuCatalog.newMenuItemList()) {
			...
			protected void addMenuItem(ListItem<IMenuItem> item, IMenuItem menuItem)
			{
				...
				{
					item.add(new MoveToPositionPanel("item", (MoveToPositionMenuItem) menuItem, ContentextMenuCatalog.this));
